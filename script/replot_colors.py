...
if __name__ == "__main__":
    ...
    colorByPolicy(data, inflect, accuracies=accTab, outfile="figures/english-x-irish-colorplot")
    ...
    accTab = accuracyTable(data, inflect)
    colorByPolicy(data, inflect, accuracies=accTab, outfile="figures/irish-colorplot")
